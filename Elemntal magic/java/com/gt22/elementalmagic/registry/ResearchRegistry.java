...
public class ResearchRegistry {
	...
	private static void registerResearches()
	{
		...
		ResearchItem elemfocies = new ResearchItem("elemfocies", tabname, AdvThaumApi.getElementas(10).add(Aspect.CRYSTAL, 5), 0, -2, 1, new ItemStack(ItemRegistry.craftItem, 1, 0));
		...
		ResearchItem elemrod = new ResearchItem("ROD_ELEM", tabname, AdvThaumApi.getElementas(15).add(Aspect.MAGIC, 10), -1, 2, 2, new ItemStack(ItemRegistry.elemRod));
		...
		ResearchItem elemcap = new ResearchItem("CAP_ELEMCAP", tabname, AdvThaumApi.getElementas(15).add(Aspect.MAGIC, 5).add(Aspect.METAL, 5), 1, 2, 2, new ItemStack(ItemRegistry.elemCap));
		...
		ResearchItem elemingot = new ResearchItem("elemingot", tabname, AdvThaumApi.getElementas(20).add(Aspect.METAL, 5), -2, 0, 2, new ItemStack(ItemRegistry.craftItem, 1, 1));
		ResearchPage elemingotpage = new ResearchPage(researchprefix + "elemingot.text"), elemingotpage2 = new ResearchPage(CrucibleRecipeRegistry.elemIngot), elemingotpage3 = new ResearchPage(ArcaneRecipeRegistry.tools), elemingotpage4 = new ResearchPage(MetalBlock.recepies[0]);
		...
		ResearchItem autodecomp = new ResearchItem("autodecomp", tabname, AdvThaumApi.getElementas(10).add(Aspect.CRAFT, 20), -3, 1, 2, new ItemStack(BlockRegistry.autoDecompTable));
