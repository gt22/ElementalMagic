...
public class ResearchRegistry {
	...
	private static void registerResearches()
	{
		...
		ResearchItem elemrod = new ResearchItem("ROD_ELEMWAND", tabname, AdvThaumApi.getElementas(15).add(Aspect.MAGIC, 10), -2, 2, 2, new ItemStack(ItemRegistry.elemRod));
		...
		ResearchPage autodecomppage = new ResearchPage(researchprefix + "autodecomp.text"), autodecomppage2 = new ResearchPage(InfusionRecipeRegistry.autoDecomTable), autodecomppage3 = new ResearchPage(ArcaneRecipeRegistry.boundMatrix);
		...
		ResearchPage altrsrdpage = new ResearchPage(researchprefix + "altrsrd.text"), altrsrdpage2 = new ResearchPage(ArcaneRecipeRegistry.altrsrd);
